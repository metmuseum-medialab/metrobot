...
int signatureWidth = 70;
int signatureHeight = 70;
...
//====================FUNCTION FOR GETTING THE COLOR OF A SUBSAMPLE OF AN IMAGE======================
//color getAverageColor(PImage theImg, int xPos, int yPos, int xWidth, int yHeight){
